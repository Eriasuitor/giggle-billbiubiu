  ...
  amount: 10000,
    ...
    status: 'new',
    remark: 'This is a test income record',
                }],
                transfers: [],
                colors: [{
                    value: 'pink',
                ...
                wallets: [{
                    ...
                    lastEditedAt: new Date().getTime(),
                    status: 'new',
                    remark: 'This is a test wallets record',
                },
                {
                    id: 1002,
                    name: '个人生存2',
            ...
            this.props.navigation.navigate({
                ...
                params: {
                    callback: income => {
                        ...
                        this.setState(this.state)
                        alert(JSON.stringify(this.state.incomes))
                        this.saveItem()
                    },
                    headerTitle: '收入',
                    returnAsObject: true,
                    formItems: [
                        {
                            ...
                            type: 'checkbox',
                            key: 'walletId',
                            options: this.state.wallets.map(_w => ({name: _w.name, value: _w.id}))
                        }
                    ]
                }
            })
            ...
            return (
                <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.menu}>
                        ...
                        <View style={styles.button}
                            onTouchStart={() => this.newIncome()}
                        >
                            <TextOrigin style={styles.option}>收入</TextOrigin>
                        </View>
                        <View style={styles.button}
                            onTouchStart={() => this.go()}
                        >
                            <TextOrigin style={styles.option}>转账</TextOrigin>
                        </View>
                        <View style={styles.button}
                        ...
                        >
                            <TextOrigin style={styles.option}>重置</TextOrigin>
                        </View>
                    </View>
                </View>
            );
